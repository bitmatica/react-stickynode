...
var Sticky = (function (_Component) {
    ...
    _createClass(Sticky, [{
        ...
        value: function update(state) {
            ...
            var disabled = !this.props.enabled || state.bottomBoundary - state.topBoundary <= state.height || state.width === 0 && state.height === 0;
                ...
                if (state.height > winHeight - state.top) {
                    ...
                    switch (state.status) {
                        ...
                        case STATUS_FIXED:
                            ...
                            } else if (delta < 0 && pos === state.bottom - height) {
                                // case 2, and scrolling up
                                this.stickyBottom = bottom - delta;
                                this.stickyTop = this.stickyBottom - height;
                            } else if (pos !== state.bottom - height && pos !== state.top) {
                                // case 3
